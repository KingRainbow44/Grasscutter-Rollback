...
@Command(label = "rollback", aliases = {"rb"},
        usage = "/rollback", permission = "grasscutter.rollback",
...
public final class RollbackCommand implements CommandHandler {
    ...
    public void execute(Player sender, Player targetPlayer, List<String> args) {
        ...
        var gameBackup = gameClient.getDatabase(
                "bk_" + gameDatabase.getName());
        var serverBackup = serverClient.getDatabase(
                "bk_" + serverDatabase.getName());
        ...
        Rollback.getPluginLogger().info("Rollback was completed by {}. Server is restarting in 5s.",
